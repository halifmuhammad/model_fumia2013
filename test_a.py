...
dataset_fumianet = join(dirname(model_fumia2013.__file__), 
    'dataset-fumia-curated-rev1.txt')
output_a1 = join(dirname(model_fumia2013.__file__),
    'output-a1-fumia-model-processed-weighted-sum.txt')
output_a2 = join(dirname(model_fumia2013.__file__), 
    'output-a2-fumia-model-processed-logic.txt')
